			...
			<div class="col-sm-8 wrap-about py-5 ftco-animate img" style="background-image: url(images/about.jpg);">
				<div class="row pb-5 pb-md-0">
					<div class="col-md-12 col-lg-7">
						...
						<div class="pl-lg-3 ml-md-5">
							<p>Our experienced chefs bring together traditional techniques and innovative approaches to create extraordinary culinary experiences. Each dish is carefully crafted using the finest ingredients to deliver authentic flavors.</p>
						</div>
					</div>
				</div>
			</div>
