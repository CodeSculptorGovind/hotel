					...
					<div class="row">
						<div class="col-md-6">
							<ul class="list-unstyled">
								<li><i class="fa fa-cutlery text-primary"></i> Fine Dining</li>
								<li><i class="fa fa-shopping-bag text-primary"></i> Takeaway Orders</li>
								<li><i class="fa fa-calendar text-primary"></i> Table Reservations</li>
							</ul>
						</div>
						<div class="col-md-6">
							<ul class="list-unstyled">
								<li><i class="fa fa-glass text-primary"></i> Full Bar & Liquor</li>
								<li><i class="fa fa-users text-primary"></i> Private Events</li>
								<li><i class="fa fa-heart text-primary"></i> Special Occasions</li>
							</ul>
						</div>
					</div>
				</div>
